...
| B05 | `/help/buyer/orders` | Desktop 1440×900 + Mobile 390×844 | Pending owned order-detail capture | Pending | Receive/review/dispute state-transition evidence plus a final PII-safe Desktop/Mobile capture remain pending |
...
| B07 | `/help/buyer/chat-shop` | Desktop 1440×900 + Mobile 390×844 | Pending two-session chat capture | Pending | Send/receive/history/reconnect, supported metadata and final Desktop/Mobile capture remain pending |
...
| S01 | `/help/seller/register-shop` | Desktop 1440×900 + Mobile 390×844 | Pending approved seller capture | Pending | Authenticated submit/state transition, KYC/media fixture and final Desktop/Mobile capture remain pending |
| S02 | `/help/seller/shop-setup` | Desktop 1440×900 + Mobile 390×844 | Pending approved seller capture | Pending | Owned shop/business edit persistence and final Desktop/Mobile capture remain pending |
| S03 | `/help/seller/create-product` | Desktop 1440×900 + Mobile 390×844 | Pending approved seller capture | Pending | Product/media/variant/stock/moderation submission and final Desktop/Mobile capture remain pending |
| S04 | `/help/seller/manage-products` | Desktop 1440×900 + Mobile 390×844 | Pending approved seller capture | Pending | Edit/variant/media ownership and reload evidence plus final Desktop/Mobile capture remain pending |
| S05 | `/help/seller/process-order` | Desktop 1440×900 + Mobile 390×844 | Pending approved seller capture | Pending | Seller transition/audit/ownership evidence and a PII-safe final Desktop/Mobile capture remain pending |
| S06 | `/help/seller/voucher` | Desktop 1440×900 + Mobile 390×844 | Pending approved seller capture | Pending | Create/edit/activate/deactivate/eligibility evidence and final Desktop/Mobile capture remain pending |
...
| S09 | `/help/seller/livestream` | Desktop 1440×900 + Mobile 390×844 | Pending approved seller capture | Pending | Create/start/pin/Agora host, viewer interaction/end evidence and final Desktop/Mobile capture remain pending |
...
| A02 | `/help/admin/admin-users` | Desktop 1440×900 + Mobile 390×844 | Pending targeted Admin visual evidence | No final visual yet | List/detail/filter assertions and a PII-reviewed final Desktop/Mobile capture remain pending |
...
| A04 | `/help/admin/admin-shop-review` | Desktop 1440×900 + Mobile 390×844 | Pending targeted Admin visual evidence | No final visual yet | Pending shop fixture, approve/reject/activation audit evidence and final PII-reviewed Desktop/Mobile capture remain pending |
...
| A08 | `/help/admin/admin-wallet` | Desktop 1440×900 + Mobile 390×844 | Pending targeted Admin visual evidence | No final visual yet | Payout/withdrawal audit evidence and a final PII-safe Desktop/Mobile capture remain pending; production financial mutation is prohibited |
