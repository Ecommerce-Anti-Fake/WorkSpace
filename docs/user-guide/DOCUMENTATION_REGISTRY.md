...
| Buyer | `B03` | `/help/qr/verify-product` | PARTIAL | Public B03/open entry and B03/enter-code input visuals are captured and production-verified at Desktop/Mobile; known positive fixture/result capture remains pending |
