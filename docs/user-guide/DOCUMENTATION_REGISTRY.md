...
| Buyer | `livestream` | `/help/buyer/livestream` | PARTIAL | Pending |
...
| Seller | `register-shop` | `/help/seller/register-shop` | SOURCE_VERIFIED | Pending authenticated capture |
...
| Seller | `affiliate` | `/help/seller/affiliate` | PARTIAL | Pending authenticated capture |
| Seller | `livestream` | `/help/seller/livestream` | PARTIAL | Pending authenticated capture |
...
| Seller | `S09` | `/help/seller/livestream` | PARTIAL | Pending authenticated capture |
