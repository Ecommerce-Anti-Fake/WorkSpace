...
| WorkSpace | Latest pushed `main` read through `FETCH_HEAD` at `2eb3e1396499b8644792701639485e7550ce9dfe`. The supplied audit/spec inputs remain untracked and are not treated as canonical changes. |
